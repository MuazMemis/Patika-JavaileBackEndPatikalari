...
import Dersler.Bolum03MaceraOyunu.Game;
import Dersler.Bolum03MaceraOyunu.Locations.Location;
import Dersler.Bolum03MaceraOyunu.Obstacles.Obstacle;
...
public abstract class BattleLocation extends Location {
    ...
    public boolean onLocation() {
        ...
        Game.input.nextLine();
        String selectCase = Game.input.nextLine().toUpperCase(Locale.ROOT);
    ...
    public boolean combat(int obsNumber) {
        for (int i = 1; i <= obsNumber; i++) {
            ...
            while (this.getPlayer().getHealth() > 0 && this.getObstacle().getHealth() > 0) {
                ...
                String selectCombat = Game.input.nextLine().toUpperCase(Locale.ROOT);
