package Dersler.Bolum02NesneYonelimliProgramlama.Ders4MethodOverriding;
...
public class Calisan {
    ...
    public void giris(String girisSaati, String cikisSaati) {
        System.out.println(this.getAdSoyad() + " " + girisSaati + " üniversiteye giriş yaptı " + cikisSaati + " da çıkacak.");
    }
